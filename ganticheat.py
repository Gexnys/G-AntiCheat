...
def displayLoadingScreen():
    def animate_progress():
        ...
        while value < 100:
            ...
            progress_label.config(text=f"Loading... {value}%")
    ...
    root.wm_attributes("-transparentcolor", "#2d2f38")
    ...
    try:
        ...
        Label(root, text="G-AntiCheat", font=("Arial", 16, "bold"), bg="#2d2f38", fg="blue").pack(pady=20)

    progress_var = IntVar()
    style = ttk.Style()
    style.theme_use('clam')
    style.configure("blue.Horizontal.TProgressbar", troughcolor="#222121", background="blue")
    progress_bar = ttk.Progressbar(root, orient="horizontal", length=270, mode="determinate",
                                   variable=progress_var, maximum=100, style="blue.Horizontal.TProgressbar")
